...
export const questions: Question[] = [
  ...
  },
  {
    ...
    "options": {
      "A": "Data augmentation for imbalanced classes Most Voted",
  ...
  },
  {
    ...
    "options": {
      ...
      "C": "Create an Amazon Bedrock knowledge base. Most Voted",
  ...
  },
  {
    ...
    "options": {
      ...
      "B": "Generate simple metrics, reports, and examples by using Amazon SageMaker Clarify. Most Voted",
  ...
  },
  {
    ...
    "options": {
      ...
      "B": "Threat detection Most Voted",
      "C": "Data protection Most Voted",
      "D": "Cost optimization"
    },
    "correct_answer": ["B", "C"]
  },
  ...
  },
  {
    ...
    "correct_answer": ["A", "B", "C", "D"],  // 题干描述为多用途选择，实际答案可根据具体使用情境细化
    "hasError": true
  },
  {
    "question_id": 126,
  ...
  },
  {
    ...
    hasError: true,
    "correct_answer": ["A", "B", "C"]  // 该题为热点题 (Hotspot)，原文未列出完整配对，仅选项推断正确性
  },
  {
    "question_id": 136,
  ...
  {
    "question_id": 143,
    "question": "A company is training its employees on how to structure prompts for foundation models. Select the correct prompt engineering technique from the following list for each prompt template. Each prompt engineering technique should be selected one time.",
    "options": {
      "A": "Few-shot prompting",
      "B": "Zero-shot prompting",
  ...
  {
    "question_id": 155,
    "question": "A company wants more customized responses to its generative AI models’ prompts. Select the correct customization methodology from the following list for each use case. Each use case should be selected one time.",
    "options": {
