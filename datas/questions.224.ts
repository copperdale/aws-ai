...
export const questions: Question[] = [
  {
    ...
    "correct_answer": ["B"],
    "explanation": "PDPs quantitatively show the relationship between features and predictions while marginalizing other features."
  },
  {
    "question_id": 2,
    ...
    "correct_answer": ["C"],
    "explanation": "Summarization is a core capability of LLMs for document processing."
  },
  {
    "question_id": 3,
    ...
    "correct_answer": ["A"],
    "explanation": "Decision trees provide native interpretability through their rule-based structure."
  },
  {
    "question_id": 4,
    ...
    "correct_answer": ["B"],
    "explanation": "Accuracy is the most straightforward metric for classification tasks."
  },
  {
    "question_id": 5,
    ...
    "correct_answer": ["A"],
    "explanation": "Prompt engineering is the most efficient way to control LLM output characteristics."
  },
  {
    "question_id": 6,
    ...
    "correct_answer": ["C"],
    "explanation": "Asynchronous inference is designed for large payloads and long processing times while providing near real-time results."
  },
  {
    "question_id": 7,
    ...
    "correct_answer": ["B"],
    "explanation": "Transfer learning allows adapting pre-trained models to new tasks with minimal training."
  },
  {
    "question_id": 8,
  ...
  },
  {
    ...
    "correct_answer": ["A"],
    "explanation": "IAM roles must have explicit decrypt permissions for SSE-S3 encrypted data."
  },
  {
    "question_id": 10,
    ...
    "correct_answer": ["A"],
    "explanation": "Small language models are optimized for low-latency edge deployment."
  },
  {
    "question_id": 11,
    ...
    "correct_answer": ["A"],
    "explanation": "Feature Store provides centralized feature management for team collaboration."
  },
  {
    "question_id": 12,
    ...
    "correct_answer": ["A"],
    "explanation": "Amazon Q Developer specializes in code generation and software development assistance."
  },
  {
    "question_id": 13,
    ...
    "correct_answer": ["A"],
    "explanation": "PrivateLink enables private connectivity without internet exposure."
  },
  {
    "question_id": 14,
    ...
    "correct_answer": ["C"],
    "explanation": "Simple rule-based calculation is most efficient for deterministic probability problems."
  },
  {
    "question_id": 15,
    ...
    "correct_answer": ["C"],
    "explanation": "Response time directly measures operational efficiency."
  },
  {
    "question_id": 16,
    ...
    "correct_answer": ["B"],
    "explanation": "Amazon Transcribe specializes in audio-to-text conversion for analysis."
  },
  {
    "question_id": 17,
    ...
    "correct_answer": ["B"],
    "explanation": "Unsupervised learning is ideal for discovering patterns in unlabeled data."
  },
  {
    "question_id": 18,
    ...
    "correct_answer": ["A"],
    "explanation": "Multi-modal models process both text and image inputs simultaneously."
  },
  {
    "question_id": 19,
    ...
    "correct_answer": ["A"],
    "explanation": "Fine-tuning requires properly formatted labeled data pairs."
  },
  {
    "question_id": 20,
    ...
    "correct_answer": ["C"],
    "explanation": "Anomaly detection identifies suspicious patterns like malicious IP addresses."
  },
  {
    "question_id": 21,
    ...
    "correct_answer": ["C"],
    "explanation": "OpenSearch's k-NN plugin provides vector search capabilities required for building vector databases."
  },
  {
    "question_id": 22,
    ...
    "correct_answer": ["B"],
    "explanation": "Text-to-image generation is a core capability of generative AI models."
  },
  {
    "question_id": 23,
    ...
    "correct_answer": ["B"],
    "explanation": "Context window determines the maximum input size (in tokens) a model can process in a single prompt."
  },
  {
    "question_id": 24,
    ...
    "correct_answer": ["C"],
    "explanation": "Prompt engineering is the most effective way to control response style and tone."
  },
  {
    "question_id": 25,
    ...
    "correct_answer": ["A"],
    "explanation": "Few-shot learning with labeled examples is effective for classification tasks with LLMs."
  },
  {
    "question_id": 26,
    ...
    "correct_answer": ["B"],
    "explanation": "CloudTrail logs all API calls, including unauthorized access attempts."
  },
  {
    "question_id": 27,
    ...
    "correct_answer": ["A"],
    "explanation": "SageMaker Serverless Inference provides fully managed model hosting."
  },
  {
    "question_id": 28,
    ...
    "correct_answer": ["B"],
    "explanation": "AWS Artifact provides on-demand access to compliance reports."
  },
  {
    "question_id": 29,
    ...
    "correct_answer": ["A"],
    "explanation": "Defensive prompt engineering can mitigate prompt injection attacks."
  },
  {
    "question_id": 30,
    ...
    "correct_answer": ["D"],
    "explanation": "Fully custom models require the most security ownership per AWS shared responsibility model."
  },
  {
    "question_id": 31,
    ...
    "correct_answer": ["A"],
    "explanation": "Object detection models can classify and locate multiple objects in images."
  },
  {
    "question_id": 32,
    ...
    "correct_answer": ["A"],
    "explanation": "On-Demand pricing requires no upfront commitment and charges per token usage."
  },
  {
    "question_id": 33,
    ...
    "correct_answer": ["B"],
    "explanation": "SageMaker JumpStart provides pre-configured FMs deployable in private VPCs."
  },
  {
    "question_id": 34,
    ...
    "correct_answer": ["A"],
    "explanation": "Prompt engineering combined with IAM least privilege forms a security baseline."
  },
  {
    "question_id": 35,
    ...
    "correct_answer": ["A"],
    "explanation": "GPT models can translate natural language to SQL effectively."
  },
  {
    "question_id": 36,
    ...
    "correct_answer": ["B"],
    "explanation": "Inference refers to applying a trained model to new data."
  },
  {
    "question_id": 37,
    ...
    "correct_answer": ["A"],
    "explanation": "Augmenting underrepresented groups in training data mitigates bias."
  },
  {
    "question_id": 38,
    ...
    "correct_answer": ["C"],
    "explanation": "Knowledge bases allow FMs to access private data without retraining."
  },
  {
    "question_id": 39,
    ...
    "correct_answer": ["B"],
    "explanation": "SageMaker Clarify provides model explainability features for compliance."
  },
  {
    "question_id": 40,
    ...
    "correct_answer": ["B", "C"],
    "explanation": "Security (threat detection) and privacy (data protection) are core compliance requirements."
  },
  {
    "question_id": 41,
    ...
    "correct_answer": ["B"],
    "explanation": "Increasing training epochs typically improves model accuracy until convergence."
  },
  {
    "question_id": 42,
    ...
    "correct_answer": ["B"],
    "explanation": "Call duration directly measures operational efficiency improvements."
  },
  {
    "question_id": 43,
    ...
    "correct_answer": ["D"],
    "explanation": "SageMaker Clarify specializes in bias detection and model explainability."
  },
  {
    "question_id": 44,
    ...
    "correct_answer": ["C"],
    "explanation": "More diverse training data helps improve generalization to real-world scenarios."
  },
  {
    "question_id": 45,
    ...
    "correct_answer": ["B", "D"],
    "explanation": "Comprehend provides NLP sentiment analysis, Bedrock offers advanced LLM capabilities."
  },
  {
    "question_id": 46,
    ...
    "correct_answer": ["D"],
    "explanation": "Knowledge bases provide efficient document retrieval without full model retraining."
  },
  {
    "question_id": 47,
    ...
    "correct_answer": ["D"],
    "explanation": "Pre-labeled benchmark datasets provide standardized evaluation metrics."
  },
  {
    "question_id": 48,
    ...
    "correct_answer": ["C"],
    "explanation": "Prompt engineering is the most efficient way to control output style."
  },
  {
    "question_id": 49,
    ...
    "correct_answer": ["A", "C"],
    "explanation": "Bias mitigation requires both data analysis (A) and model transparency (C)."
  },
  {
    "question_id": 50,
    ...
    "correct_answer": ["A"],
    "explanation": "Provisioned Throughput is required for custom model access in Bedrock."
  },
  {
    "question_id": 51,
    ...
    "correct_answer": ["B"],
    "explanation": "Human evaluation with domain-specific prompts best assesses response style."
  },
  {
    "question_id": 52,
    ...
    "correct_answer": ["C"],
    "explanation": "Unauthorized use of AI-generated content constitutes plagiarism."
  },
  {
    "question_id": 53,
    ...
    "correct_answer": ["D"],
    "explanation": "Trainium (Trn) instances are optimized for energy-efficient ML training."
  },
  {
    "question_id": 54,
    ...
    "correct_answer": ["C"],
    "explanation": "Guardrails filter inappropriate content for child-safe outputs."
  },
  {
    "question_id": 55,
    ...
    "correct_answer": ["A"],
    "explanation": "GANs specialize in generating synthetic data resembling training data."
  },
  {
    "question_id": 56,
    ...
    "correct_answer": ["D"],
    "explanation": "SageMaker Canvas provides no-code ML modeling capabilities."
  },
  {
    "question_id": 57,
    ...
    "correct_answer": ["B"],
    "explanation": "Sampling bias occurs when training data underrepresents certain groups."
  },
  {
    "question_id": 58,
    ...
    "correct_answer": ["B"],
    "explanation": "Reinforcement learning optimizes behavior based on feedback rewards."
  },
  {
    "question_id": 59,
    ...
    "correct_answer": ["A"],
    "explanation": "Confusion matrices provide detailed classification accuracy breakdown."
  },
  {
    "question_id": 60,
    ...
    "correct_answer": ["A"],
    "explanation": "Moderation APIs (e.g., Rekognition Content Moderation) filter inappropriate content."
  },
  {
    "question_id": 61,
    ...
    "correct_answer": ["B"],
    "explanation": "Amazon Bedrock's native invocation logging captures detailed model I/O data."
  },
  {
    "question_id": 62,
    ...
    "correct_answer": ["A"],
    "explanation": "Batch transform is optimized for offline processing of large datasets."
  },
  {
    "question_id": 63,
    ...
    "correct_answer": ["A"],
    "explanation": "Embeddings capture semantic relationships in vector space."
  },
  {
    "question_id": 64,
    ...
    "correct_answer": ["B"],
    "explanation": "Domain adaptation tailors the model to specialized terminology."
  },
  {
    "question_id": 65,
    ...
    "correct_answer": ["A"],
    "explanation": "Lower temperature reduces response randomness."
  },
  {
    "question_id": 66,
    ...
    "correct_answer": ["A"],
    "explanation": "Granular IAM roles enforce least privilege access at the team level."
  },
  {
    "question_id": 67,
    ...
    "correct_answer": ["C"],
    "explanation": "Bedrock Guardrails with CloudWatch provides integrated PII filtering and alerting."
  },
  {
    "question_id": 68,
    ...
    "correct_answer": ["A"],
    "explanation": "Textract specializes in document text extraction including PDFs."
  },
  {
    "question_id": 69,
    ...
    "correct_answer": ["B"],
    "explanation": "Prompt conditioning is the most efficient way to control response style."
  },
  {
    "question_id": 70,
    ...
    "correct_answer": ["D"],
    "explanation": "BERTScore is commonly used for evaluating classification models."
  },
  {
    "question_id": 71,
    ...
    "correct_answer": ["C"],
    "explanation": "QuickSight Q generates visualizations from natural language queries."
  },
  {
    "question_id": 72,
    ...
    "correct_answer": ["C"],
    "explanation": "Few-shot learning requires input-output example pairs (user message → intent)."
  },
  {
    "question_id": 73,
    ...
    "correct_answer": ["B"],
    "explanation": "Reducing prompt length directly decreases token usage costs."
  },
  {
    "question_id": 74,
    ...
    "correct_answer": ["B"],
    "explanation": "Hallucination refers to confident but incorrect outputs."
  },
  {
    "question_id": 75,
    ...
    "correct_answer": ["B"],
    "explanation": "Dynamic masking prevents sensitive data exposure during inference."
  },
  {
    "question_id": 76,
    ...
    "correct_answer": ["A"],
    "explanation": "BLEU score is the standard metric for translation quality."
  },
  {
    "question_id": 77,
    ...
    "correct_answer": ["B"],
    "explanation": "Agents automate multi-step workflows like customer support processes."
  },
  {
    "question_id": 78,
    ...
    "correct_answer": ["B"],
    "explanation": "Continuous pre-training adapts models to evolving data patterns."
  },
  {
    "question_id": 79,
    ...
    "correct_answer": ["A"],
    "explanation": "Tokens are the atomic processing units for LLMs (typically 3/4 of a word)."
  },
  {
    "question_id": 80,
    ...
    "correct_answer": ["A"],
    "explanation": "Bedrock charges are based on input/output token counts."
  },
  {
    "question_id": 81,
    ...
    "correct_answer": ["C"],
    "explanation": "VPC S3 endpoints provide secure, low-latency data transfer."
  },
  {
    "question_id": 82,
    "question": "A company has developed a foundation model (FM) that was customized by using Amazon Bedrock to answer customer queries about products. The company wants to validate the model's responses to new types of queries. The company needs to upload a new dataset that Amazon Bedrock can use for validation. Which AWS service meets these requirements?",
    "options": {
      "A": "Amazon S3",
    ...
    "correct_answer": ["A"],
    "explanation": "Amazon S3 is the primary data source for Bedrock validation datasets."
  },
  {
    "question_id": 83,
    ...
    "correct_answer": ["D"],
    "explanation": "Prompt extraction attacks reveal system prompts and instructions."
  },
  {
    "question_id": 84,
    ...
    "correct_answer": ["C"],
    "explanation": "Data protection is always the customer's responsibility under AWS shared responsibility model."
  },
  {
    "question_id": 85,
    ...
    "correct_answer": ["B"],
    "explanation": "Automated evaluation provides standardized toxicity scoring."
  },
  {
    "question_id": 86,
    ...
    "correct_answer": ["D"],
    "explanation": "Jailbreaking refers to bypassing model safety restrictions."
  },
  {
    "question_id": 87,
    ...
    "correct_answer": ["B"],
    "explanation": "Network isolation blocks all internet access for compliance."
  },
  {
    "question_id": 88,
    ...
    "correct_answer": ["C"],
    "explanation": "SageMaker Model Cards provide standardized model documentation."
  },
  {
    "question_id": 89,
    ...
    "correct_answer": ["D"],
    "explanation": "AI-powered code generation (e.g., CodeWhisperer) boosts developer productivity."
  },
  {
    "question_id": 90,
    ...
    "correct_answer": ["C"],
    "explanation": "DeepAR specializes in time-series forecasting."
  },
  {
    "question_id": 91,
    ...
    "correct_answer": ["D"],
    "explanation": "Addressing class imbalance helps prevent demographic bias."
  },
  {
    "question_id": 92,
    ...
    "correct_answer": ["A"],
    "explanation": "Adversarial prompt engineering hardens models against injections."
  },
  {
    "question_id": 93,
    ...
    "correct_answer": ["C"],
    "explanation": "F1 score balances precision and recall for QA evaluation."
  },
  {
    "question_id": 94,
    ...
    "correct_answer": ["C"],
    "explanation": "Higher CFG scale increases adherence to text prompts."
  },
  {
    "question_id": 95,
    ...
    "correct_answer": ["C"],
    "explanation": "RAG dynamically retrieves relevant policy content without model retraining."
  },
  {
    "question_id": 96,
    ...
    "correct_answer": ["A"],
    "explanation": "Amazon Q Developer provides AI-assisted Glue script generation."
  },
  {
    "question_id": 97,
    ...
    "correct_answer": ["A"],
    "explanation": "Diverse training data promotes equitable model performance."
  },
  {
    "question_id": 98,
    ...
    "correct_answer": ["A"],
    "explanation": "Clarify provides both bias detection and explainability features."
  },
  {
    "question_id": 99,
    ...
    "correct_answer": ["C"],
    "explanation": "BERTScore evaluates semantic similarity between generated and reference summaries."
  },
  {
    "question_id": 100,
    ...
    "correct_answer": ["A"],
    "explanation": "k-NN is effective for multi-feature classification tasks."
  },
  {
    "question_id": 101,
    ...
    "correct_answer": ["A"],
    "explanation": "AWS KMS enables customer-managed encryption keys for model artifacts."
  },
  {
    "question_id": 102,
    ...
    "correct_answer": ["B"],
    "explanation": "Code generation is a text generation capability of LLMs."
  },
  {
    "question_id": 103,
    ...
    "correct_answer": ["C"],
    "explanation": "ROUGE evaluates text coherence against reference examples."
  },
  {
    "question_id": 104,
    ...
    "correct_answer": ["B"],
    "explanation": "Negative prompts explicitly exclude undesired content."
  },
  {
    "question_id": 105,
    ...
    "correct_answer": ["B"],
    "explanation": "Structured prompting with category-specific templates ensures consistency."
  },
  {
    "question_id": 106,
    ...
    "correct_answer": ["B"],
    "explanation": "Increased regularization reduces overfitting to training data."
  },
  {
    "question_id": 107,
    ...
    "correct_answer": ["B"],
    "explanation": "Aurora PostgreSQL with pgvector extension supports vector embeddings."
  },
  {
    "question_id": 108,
    ...
    "correct_answer": ["A"],
    "explanation": "Simpler models (e.g., decision trees) are inherently more explainable."
  },
  {
    "question_id": 109,
    ...
    "correct_answer": ["B"],
    "explanation": "LLMs are ideal for text summarization tasks."
  },
  {
    "question_id": 110,
    ...
    "correct_answer": ["A"],
    "explanation": "Logistic regression provides interpretable feature weights."
  },
  {
    "question_id": 111,
    ...
    "correct_answer": ["C"],
    "explanation": "Use-case-specific evaluation matters most for business impact."
  },
  {
    "question_id": 112,
    ...
    "correct_answer": ["A"],
    "explanation": "Labeled datasets require supervised learning approaches."
  },
  {
    "question_id": 113,
    ...
    "correct_answer": ["D"],
    "explanation": "Compliance needs are defined during business objective setting."
  },
  {
    "question_id": 114,
    ...
    "correct_answer": ["A"],
    "explanation": "SageMaker supports continuous model retraining pipelines."
  },
  {
    "question_id": 115,
    ...
    "correct_answer": ["D"],
    "explanation": "SageMaker endpoints provide fully managed model deployment."
  },
  {
    "question_id": 116,
    ...
    "correct_answer": ["B"],
    "explanation": "Agents with knowledge bases provide document retrieval capabilities."
  },
  {
    "question_id": 117,
    ...
    "correct_answer": ["C"],
    "explanation": "Visual inspection is a computer vision application."
  },
  {
    "question_id": 118,
    ...
    "correct_answer": ["B"],
    "explanation": "SageMaker Automatic Model Tuning (AMT) automates hyperparameter optimization."
  },
  {
    "question_id": 119,
    ...
    "correct_answer": ["A"],
    "explanation": "Human review filters harmful content before delivery."
  },
  {
    "question_id": 120,
    ...
    "correct_answer": ["A"],
    "explanation": "Data diversity improvement is the most direct bias mitigation approach."
  },
